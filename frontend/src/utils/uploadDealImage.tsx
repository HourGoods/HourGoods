...
export default function uploadDealImage(file: any, filename: any) {
  ...
  const upload = new AWS.S3.ManagedUpload({
    params: {
      ...
      Key: `image/deal/${today}+${filenameShort}`, // 업로드 위치와 업로드할 파일명, 유저 프로필은 경로를 image/member-profile/로 넣어주세요
