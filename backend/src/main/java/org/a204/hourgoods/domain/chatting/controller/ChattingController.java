...
public class ChattingController {
	...
	@ApiResponse(responseCode = "200", description = "채팅방 생성 성공", content = @Content(schema = @Schema(implementation = DirectChattingResponse.class)))
	@ApiResponse(responseCode = "404", description = "1. CH100 채팅을 요청한 상대 정보 찾을 수 없음 \t\n 2. D200 거래를 찾을 수 없음 \t\n 3.M300 유저 정보가 잘못되었음")
	@PostMapping("/direct")
	@PreAuthorizeMember
	public BaseResponse<DirectChattingResponse> enterDirectChatRoom(
	...
	@GetMapping("/list")
	@PreAuthorizeMember
	public BaseResponse<List<MyDirectChatResponse>> getMyChatList(
