...
public class ConcertController {
	...
	@PostMapping()
	public BaseResponse<ConcertIdResponse> getConcertId(@RequestParam(name = "kopisConcertId") String kopisConcertId) {
		ConcertIdResponse response = concertService.getConcertId(kopisConcertId);
	...
	@GetMapping()
	public BaseResponse<ConcertInfoResponse> getConcertList(@RequestParam(name = "concertId") Long concertId) {
	...
	@GetMapping("/today")
	public BaseResponse<TodayConcertListResponse> getConcertList(@Valid TodayConcertRequest todayConcertRequest) {
